...
def dibujar_creditos(pantalla: pygame.Surface, fuentes: dict):
    ...
    centrar("titulo",  "ARQUERIA EDUCATIVA",         100, AMARILLO)
    ...
    # Autores (completar con los nombres reales del grupo)
    centrar("grande",  "Autores", 240, AMARILLO)
    centrar("normal",  "Integrante 1  -  Integrante 2  -  Integrante 3", 285, BLANCO)
    centrar("pequeño", "Comision: XX   |   Grupo: XX   |   Año: 2025", 325, GRIS_CLARO)
    ...
    centrar("normal",  "Practicar calculo mental mediante mecanicas de arqueria.", 435, BLANCO)
    ...
    centrar("pequeño", "Desarrollado con Python 3 y pygame-ce  |  2025", 545, GRIS)
